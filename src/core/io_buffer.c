...
int io_bufpool_config_validate(const io_bufpool_config_t *cfg)
{
    if (cfg == nullptr) {
        return -EINVAL;
    }
...
io_bufpool_t *io_bufpool_create(const io_bufpool_config_t *cfg)
{
    if (cfg == nullptr) {
        return nullptr;
    }
    if (io_bufpool_config_validate(cfg) != 0) {
        return nullptr;
    }

    io_bufpool_t *pool = calloc(1, sizeof(*pool));
    if (pool == nullptr) {
        return nullptr;
    }
    pool->config = *cfg;
...
int io_bufpool_register_ring(io_bufpool_t *pool, struct io_uring *ring)
{
...
int io_bufpool_register_bufs(io_bufpool_t *pool, struct io_uring *ring)
{
    if (pool == nullptr || ring == nullptr) {
        return -EINVAL;
    }
...
int io_bufpool_register_files(io_bufpool_t *pool, struct io_uring *ring)
{
    if (pool == nullptr || ring == nullptr) {
        return -EINVAL;
    }
...
int io_bufpool_register_fd(io_bufpool_t *pool, struct io_uring *ring, int fd)
{
    if (pool == nullptr || ring == nullptr) {
        return -EINVAL;
    }
