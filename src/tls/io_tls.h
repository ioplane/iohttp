...
constexpr size_t IO_TLS_CIPHER_BUF_SIZE = 16384;
 ...
 */
[[nodiscard]] int io_tls_config_validate(const io_tls_config_t *cfg);
 ...
 * @return Non-null on success; nullptr on failure.
 */
[[nodiscard]] io_tls_conn_t *io_tls_conn_create(io_tls_ctx_t *ctx, int fd);
 ...
 */
[[nodiscard]] int io_tls_feed_input(io_tls_conn_t *conn, const uint8_t *data, size_t len);
 ...
 */
[[nodiscard]] int io_tls_handshake(io_tls_conn_t *conn);
 ...
 */
[[nodiscard]] int io_tls_read(io_tls_conn_t *conn, uint8_t *buf, size_t len);
 ...
 */
[[nodiscard]] int io_tls_write(io_tls_conn_t *conn, const uint8_t *buf, size_t len);
 ...
 */
[[nodiscard]] int io_tls_get_output(io_tls_conn_t *conn, const uint8_t **data, size_t *len);
 ...
 */
[[nodiscard]] int io_tls_shutdown(io_tls_conn_t *conn);
