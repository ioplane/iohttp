...
/* Parse limits */
constexpr size_t IO_HTTP1_MAX_HEADERS = 64;
constexpr size_t IO_HTTP1_MAX_HEADER_SIZE = 8192;
constexpr size_t IO_HTTP1_MAX_URI_SIZE = 4096;

/* Chunked decoder wrapper */
typedef struct {
    struct phr_chunked_decoder decoder;
    bool consume_trailer;
} io_chunked_decoder_t;

/**
 * Parse HTTP/1.1 request from buffer into io_request_t.
