...
constexpr uint32_t IO_MULTIPART_DEFAULT_MAX_PARTS = 64;
constexpr size_t IO_MULTIPART_DEFAULT_MAX_PART_SIZE = 10 * 1024 * 1024;
constexpr size_t IO_MULTIPART_DEFAULT_MAX_TOTAL_SIZE = 50 * 1024 * 1024;
