...
constexpr uint8_t IOH_PROXY_V2_SIG[12] = {0x0D, 0x0A, 0x0D, 0x0A, 0x00, 0x0D,
                                         0x0A, 0x51, 0x55, 0x49, 0x54, 0x0A};

constexpr size_t IOH_PROXY_V1_MAX_LEN = 108; /* "PROXY" + max text line */
constexpr size_t IOH_PROXY_V2_MIN_LEN = 16;  /* 12 sig + 4 header */
 ...
 */
[[nodiscard]] int ioh_proxy_decode(const uint8_t *buf, size_t len, ioh_proxy_result_t *result);
