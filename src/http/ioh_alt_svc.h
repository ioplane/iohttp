 ...
 */
[[nodiscard]] int ioh_alt_svc_format(char *buf, size_t buf_len, uint16_t port, uint32_t max_age);
 ...
 */
[[nodiscard]] int ioh_alt_svc_add_header(ioh_response_t *resp, uint16_t port, uint32_t max_age);
